...
const AssignRole: React.FC<AssignRoleProps> = ({
  ...
  return (
    <Modal title="分配角色" open={isAssignRoleModalVisible} onCancel={handleAssignRoleCancel} footer={null}>
      <Form form={assignRoleForm} name="assign_role_form" onFinish={handleAssignRole} {...formItemLayout}>
        <Form.Item name="roles" label="角色" rules={[{ required: true, message: "请选择至少一个角色" }]}>
          <Select mode="multiple" style={{ width: "100%" }} placeholder="请选择角色" optionFilterProp="label">
